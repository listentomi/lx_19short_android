...
import static com.example.chapter3.homework.R.id.target;
...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        target.setBackgroundColor(getBackgroundColor(startColorPicker));
        ObjectAnimator animator21 = ObjectAnimator.ofFloat(target, "scaleX", 1f, 2f, 1f);
        animator21.setDuration(5000);
        animator21.setRepeatCount(ObjectAnimator.INFINITE);
        animator21.setRepeatMode(ObjectAnimator.RESTART);

        ObjectAnimator animator22 = ObjectAnimator.ofFloat(target, "scaleY", 1f, 2f, 1f);
        animator22.setDuration(5000);
        animator22.setRepeatCount(ObjectAnimator.INFINITE);
        animator22.setRepeatMode(ObjectAnimator.RESTART);
        ...
        animatorSet.playTogether(animator22);
